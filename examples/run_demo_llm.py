#!/usr/bin/env python3
"""
GrillRadar Demo Script - LLM应用工程师
一键生成面试准备报告 Markdown
...
def main():
    print("=" * 60)
    print("🔥 GrillRadar Demo - LLM应用工程师岗位面试准备")
    print("=" * 60)
    print()

    # 1. 读取简历文件
    resume_path = project_root / "examples" / "resume_llm_engineer.txt"
    ...
    # 2. 读取配置文件
    config_path = project_root / "examples" / "config_demo_llm.json"
    ...
    # 6. 保存文件
    output_path = project_root / "examples" / "demo_report_llm.md"
    ...
    print()
    print(f"🎯 下一步:")
    print(f"   1. 阅读生成的问题和参考答案")
    print(f"   2. 使用 prompt_template 进行深度练习")
    print(f"   3. 准备好迎接面试挑战！")
    print()
